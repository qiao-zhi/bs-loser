var deleteUrl = "/userLosePlan/delete.html";
var updateUrl = "/userLosePlan/update.html";
var pageUrl = "/userLosePlan/pages.html";
...
function showTable(pageInfo){
    ...
    for(var i=0,length_1 = objs.length;i<length_1;i++){
        ...
        var tr = "<tr>"
            ...
            +'<td>'+replaceNull(objs[i].plandate)+'</td>'
            +'<td>'+replaceNull(objs[i].hasfinished)+'</td>'
            +'<td>';
